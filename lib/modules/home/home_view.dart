    ...
    final mainContent = Scaffold(
      ...
      appBar: AppBar(
        title: GestureDetector(
          ...
          onTap: controller.handleTitleTap,
          child: Obx(
            () => Text(
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Category Dropdown
            Obx(() {
              if (controller.settings.categories.isEmpty)
                  ...
                  child: DropdownButton<String>(
                    value:
                        controller.selectedCategory.value.isNotEmpty &&
                            controller.settings.categories.contains(
            ...
            Expanded(
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final lottieSize = (availableHeight * 0.22).clamp(
                    110.0,
                    180.0,
                  );
                  final iconSize = (availableHeight * 0.15).clamp(60.0, 80.0);
                  final timerFontSize = (availableHeight * 0.08).clamp(
                    36.0,
                    56.0,
                  );
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Obx(() {
                              final damagotchiController =
                                  Get.find<DamagotchiController>();
                            ...
                            Obx(
                              () =>
                                  controller.currentState.value !=
                                      TimerState.idle
                                  ? Text(
                                      "현재 ${controller.currentCycle.value} / ${controller.settings.repeatCount.value} 사이클 진행 중",
                                      style: const TextStyle(
                                        color: AppColors.textLight,
                                        fontWeight: FontWeight.bold,
                                      ),
                              ...
                              child: ColorFiltered(
                                ...
                                child: Obx(() {
                                  final damagotchiController =
                                      Get.find<DamagotchiController>();
                                  final animal =
                                      damagotchiController.activeAnimal;
                                  if (animal == null)
                                    return const SizedBox.shrink();
